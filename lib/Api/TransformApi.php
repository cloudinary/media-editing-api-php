...
class TransformApi
{
     ...
     * @return \SplFileObject|\Cloudinary\MediaEditing\Model\EnqueuedResponse|\Cloudinary\MediaEditing\Model\ErrorResponse|\Cloudinary\MediaEditing\Model\ErrorResponse|\Cloudinary\MediaEditing\Model\ErrorResponse
     */
    public function transform($transform_request = null)
    {
        list($response) = $this->transformWithHttpInfo($transform_request);
        return $response;
    }
     ...
     * @throws \Cloudinary\MediaEditing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\Cloudinary\MediaEditing\Model\EnqueuedResponse|\Cloudinary\MediaEditing\Model\ErrorResponse|\Cloudinary\MediaEditing\Model\ErrorResponse|\Cloudinary\MediaEditing\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transformWithHttpInfo($transform_request = null)
    {
        $request = $this->transformRequest($transform_request);
     ...
     */
    public function transformAsync($transform_request = null)
    {
        return $this->transformAsyncWithHttpInfo($transform_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transformAsyncWithHttpInfo($transform_request = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->transformRequest($transform_request);
     ...
     */
    public function transformRequest($transform_request = null)
    {
