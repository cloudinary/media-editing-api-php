...
/**
 * EnqueuedResponse Class Doc Comment
 *
 * @category Class
 * @package  Cloudinary\MediaEditing
 * @author   OpenAPI Generator team
 ...
 */
class EnqueuedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnqueuedResponse';
     ...
     * Sets task_id
     *
     * @param string $task_id The ID of the enqueued task
     *
     * @return self
     */
